                        ...
                        <div class="login-form">
                            <form action="" class="row d-flex justify-content-center " method="post">
                                ...
                                <div class="form-group col-4">
                                    <label>Number</label>
                                    <input class="au-input au-input--full" type="number" name="number" placeholder="Number" required>
                                </div>
                                ...
                                <button class="col-8 btn au-btn--block btn-orange" type="submit" name="signup">register</button>
                                <div class="social-button col-12">
                                    <div class="register-link text-dark">
                                        <p>Already have account ? <a class="ml-2 text-light" href="login.php"> Sign In</a></p>
                                    </div>
                                </div>
                                <button class="col-8 mt-4 btn au-btn--block btn-orange"><a href="hsignup.php" class=" text-decoration-none text-white">Hospital signup</a></button>
                            </form>
                        </div>
                    </div>
                </div>
